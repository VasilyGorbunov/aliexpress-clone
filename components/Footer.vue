<template>
    ...
    <div class="max-w-[1200px] mx-auto px-4">
      ...
      <div class="md:flex gap-4 justify-between w-full">
        ...
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">Russian, Portuguese, Spanish, French, German, Italian, Dutch, Turkish, Japanese, Korean</div>
        </div>
      </div>
      ...
      <div class="md:flex gap-4 justify-between w-full">
        ...
        <div class="md:w-[50%] pt-4">
          ...
          <div class="text-[#999999] text-sm">Alibaba Group Website, AliExpress, Alimama, Alipay, Fliggy, Alibaba Cloud, Alibaba International, AliTelecom, DingTalk</div>
        </div>
      </div>
  ...
  <div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400">
    <div class="max-w-[1200px] mx-auto p-4">
      Intellectual Property Protection - Privacy Policy - Sitemap - Term of Use - Information for EU consumers - Transaction Services Agreement
    </div>
  </div>
</template>
